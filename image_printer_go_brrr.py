# Note from 2022 - this was sitting on a local drive for a year or two,\
# something that I wrote up in a couple of hours. I found it enjoyable
# enough that it warrants more fleshing out so I'm going to rework it
# and add some features going forward. Thanks for checking it out!
